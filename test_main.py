...
class TestFastAPIEndpoints:
    ...
    def test_get_youtube_caption_success(self, mock_api_class):
    ...
    def test_get_youtube_caption_missing_url(self):
    ...
    def test_get_youtube_caption_invalid_url(self):
        ...
        response_data = response.json()
        assert "Invalid YouTube URL" in response_data["detail"]
    
    def test_get_youtube_caption_invalid_json(self):
    ...
    @patch('main.YouTubeTranscriptApi')
    def test_get_youtube_caption_no_transcript_found(self, mock_api_class):
        ...
        response_data = response.json()
        assert "No transcript available" in response_data["detail"]
    
    @patch('main.YouTubeTranscriptApi')
    def test_get_youtube_caption_video_unavailable(self, mock_api_class):
        ...
        assert response.status_code == 404
        response_data = response.json()
        assert "Video is unavailable" in response_data["detail"]
    
    @patch('main.YouTubeTranscriptApi')
    def test_get_youtube_caption_transcripts_disabled(self, mock_api_class):
        ...
        response_data = response.json()
        assert "Transcripts are disabled" in response_data["detail"]
    
    @patch('main.YouTubeTranscriptApi')
    def test_get_youtube_caption_with_language_list(self, mock_api_class):
    ...
    @patch('main.YouTubeTranscriptApi')
    def test_get_youtube_caption_default_parameters(self, mock_api_class):
    ...
    @patch('main.YouTubeTranscriptApi')
    def test_get_youtube_caption_pagination(self, mock_api_class):
    ...
    @patch('main.YouTubeTranscriptApi')
    def test_get_youtube_caption_translation_fallback(self, mock_api_class):
